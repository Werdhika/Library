...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('Maaf, buku sedang dipinjam. Silakan coba lagi nanti.'); window.location='procces-browse-book.php';</script>";
} else {
    // Lakukan peminjaman
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Peminjaman Buku Berhasil!'); window.location='procces-browse-book.php';</script>";
    } else {
